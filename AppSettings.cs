...
namespace GameTranslatorUltimate
{
    ...
    public class AppSettings : INotifyPropertyChanged
    {
        ...
        private double _mainWindowWidth = 965;
        public double MainWindowWidth
        {
            get => _mainWindowWidth;
            set
            {
                if (Math.Abs(_mainWindowWidth - value) > double.Epsilon)
                {
                    ValidatePositiveDouble(value, nameof(MainWindowWidth));
        ...
        private double _mainWindowHeight = 946;
        public double MainWindowHeight
        {
            get => _mainWindowHeight;
            set
            {
                if (Math.Abs(_mainWindowHeight - value) > double.Epsilon)
                {
                    ValidatePositiveDouble(value, nameof(MainWindowHeight));
        ...
        private double _mainWindowTop = 100;
        public double MainWindowTop
        {
            get => _mainWindowTop;
            set
            {
                if (Math.Abs(_mainWindowTop - value) > double.Epsilon)
                {
        ...
        private double _mainWindowLeft = 100;
        public double MainWindowLeft
        {
            get => _mainWindowLeft;
            set
            {
                if (Math.Abs(_mainWindowLeft - value) > double.Epsilon)
                {
        ...
        private bool _hasWindowBounds = false;
        public bool HasWindowBounds
        {
            get => _hasWindowBounds;
            set { if (_hasWindowBounds != value) { _hasWindowBounds = value; OnPropertyChanged(); } }
        }
        ...
        public WindowState MainWindowState
        {
            ...
            set { if (_mainWindowState != value) { _mainWindowState = value; OnPropertyChanged(); } }
        }
        ...
        public void ResetToDefaults()
        {
            ...
            _valueMin = 200;
            _valueMax = 255;
            _hasWindowBounds = false;
            _mainWindowWidth = 965;
            _mainWindowHeight = 946;
            _mainWindowLeft = 100;
            _mainWindowTop = 100;
            _mainWindowState = WindowState.Normal;
        ...
        private void ValidatePositiveDouble(double value, string propertyName)
        {
            if (value <= 0)
            {
                throw new ArgumentOutOfRangeException(propertyName, "DeÄŸer pozitif bir sayÄ± olmalÄ±dÄ±r.");
            }
        }
